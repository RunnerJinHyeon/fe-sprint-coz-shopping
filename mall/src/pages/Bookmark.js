...
return(
    ...
    <ItemContainer>
    <BookmarkList
    buttonType={buttonType} products={products} isOnToast={isOnToast} setBookmarks={setBookmarks}
    ...
    setButtonType={setButtonType} starList={starList} setStarList={setStarList}
    />
    </ItemContainer>
    <BookmarkContainer>
