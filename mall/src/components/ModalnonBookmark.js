...
import bookmarkon from "../images/bookmark-on.png";
    ...
    <ModalContainer>
        {selectedProduct ?(
            <ModalBackdrop onClick={closeModal}>
                <ModalView onClick={(event) => {closeModal(); event.stopPropagation();}}>
                    ...
                    <IconContainer>
                        <StarIcon key={selectedProduct.id} src ={bookmarkoff} alt="img" width="23rem" height="23rem"/>
        ...
        (<ModalBackdrop onClick={closeModal}>
            <ModalView onClick={(event) => {closeModal(); event.stopPropagation();}}>
                ...
                <IconContainer>
                    <StarIcon key={selectedProductBookmark.id} src ={bookmarkon} alt="img" width="23rem" height="23rem"/>
